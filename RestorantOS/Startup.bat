...
:: curl ile health endpoint kontrol et
...
echo    Hala acilmiyorsa: docker-compose down  sonra Startup.bat
echo  ================================================
echo.
echo  Yine de tarayiciyi acmak ister misiniz?
set /p OPENBROWSER="(E/H): "
